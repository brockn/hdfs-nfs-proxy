...
public class RPCBuffer  {
  ...
  /**
   * XDR requires all data to be a multiple of 4 bytes
  ...
  /**
   * This method will read an RPC request/response from 
   * InputStream and store the resulting data in the buffer
   * @param in
   * @throws IOException
   */
  ...
  /**
   * Exactly the same as IOUtils.readFully except this
