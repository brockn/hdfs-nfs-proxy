...
public class ModeHandler extends AttributeHandler<Mode> {
  ...
  @Override
  public Mode get(HDFSState hdfsState, Session session,
  ...
  @Override
  public boolean set(HDFSState hdfsState, Session session, FileSystem fs, FileStatus fileStatus, StateID stateID, Mode attr)
