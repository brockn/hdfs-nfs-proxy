...
public class TestLogUtils {
  protected static final Logger LOGGER = Logger.getLogger(TestLogUtils.class);
  @Test
  public void testDump() {
    RPCResponse response = new RPCResponse(1, RPC_VERSION);
    ...
    LOGGER.info(LogUtils.dump(response));
  }
}
