...
public class TestPUTFHHandler extends TestBaseHandler {
  ...
  public void setup() throws Exception {
    super.setup();
    handler = new PUTFHHandler();
    request = new PUTFHRequest();
    request.setFileHandle(currentFileHandle);
  }

  @Test
  public void testFunctionality() throws Exception {
    PUTFHResponse response = handler.handle(hdfsState, session, request);
